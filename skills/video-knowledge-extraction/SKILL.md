...
|-----------|---------|-----------|-----------|
| Tutorial/Demo, Review/Analysis, Short/Clip | **Полный** | ffmpeg → filter → MCP классификация → inline | visual-channel.md |
| Lecture/Educational | **Лёгкий** | ffmpeg → filter → кадры в keyframes/ | visual-channel.md |
| Interview/Podcast, Vlog/Narrative | **Пропустить** | Ничего | visual-channel.md |
...
**1. Компрессия ~1:6.** Видео менее плотные, чем книги. 30-мин видео → 3-5 мин чтения (~600-1000 слов). 20-мин видео → 2-3 мин (~400-700 слов). Целевой размер: ~30-35 слов в минуту видео. Не 1:10 как с книгами.

**Анти-многословие:** каждое описание идеи — 1-3 предложения, не абзац. Проблемы — 1 предложение суть + 1 предложение решение. Методология — только шаги, без введений и пояснений зачем. Удалять: вводные фразы, повторения, примеры которые не добавляют знания.

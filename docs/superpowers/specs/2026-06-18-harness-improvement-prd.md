...
Сильная сторона, которую **сохраняем**: продуктовая и стратегийная дисциплина — JTBD, Minto, инфостиль Ильяхова, grill-навыки. Этого нет ни у gstack, ни у большинства пэров.

...
> **Пояснение:** Tutorial/Demo и Review/Analysis используют `0.4` (более чувствительный), потому что визуальные изменения часто — основной источник знаний. Lecture/Educational использует `0.5` (менее чувствительный) в Лёгком режиме, потому что спикер обычно озвучивает слайды и визуал подтверждает, а не добавляет знания.
